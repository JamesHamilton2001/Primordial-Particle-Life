...
#define PARTICLE_LIFE_MIN_STEP            (0.01f)
#define PARTICLE_LIFE_MAX_STEP            (PARTICLE_LIFE_MIN_FLOATING_POINT)
#define PARTICLE_LIFE_MIN_ATTRACTION      (-PARTICLE_LIFE_MIN_FLOATING_POINT)
#define PARTICLE_LIFE_MAX_ATTRACTION      (PARTICLE_LIFE_MIN_FLOATING_POINT)
